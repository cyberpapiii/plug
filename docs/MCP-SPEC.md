...
**Dual-era posture:** Plug speaks both `2025-11-25` and gated `2026-07-28`. Global gates `http.modern_downstream_enabled` and `modern_upstream_enabled` default **off**. See `docs/testing/MCP-CONFORMANCE.md`.
