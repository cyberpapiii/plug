...
- Updated doctor wording so local token files are described as the normal process-restart backing
  store they already are, not as a rare fallback-only artifact.
